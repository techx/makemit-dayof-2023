!(function (e) {
  ...
  function D(e) {
    ...
    return (
      ...
      new Promise(function (e, n) {
        ...
        (g = {}), (b = {}), (O = e.c), (v = e.h), f("prepare");
        var t = new Promise(function (e, t) {
          h = { resolve: e, reject: t };
        });
        y = {};
        return j(0), "prepare" === p && 0 === m && 0 === w && E(), t;
      })
    );
    var t;
  }
  ...
  function E() {
    ...
    if (((h = null), e))
      if (r)
        ...
        var t = [];
        for (var n in y)
          Object.prototype.hasOwnProperty.call(y, n) && t.push(_(n));
        e.resolve(t);
      }
  }
  function M(t) {
    ...
    var h = {},
      ...
      b = function () {
        console.warn(
          "[HMR] unexpected require(" + D.moduleId + ") to disposed module"
        );
      };
    for (var g in y)
      if (Object.prototype.hasOwnProperty.call(y, g)) {
        ...
        var j = !1,
          ...
          H = "";
        switch (
          ((D = y[g] ? l(s) : { type: "disposed", moduleId: g }).chain &&
          ...
          case "self-declined":
            t.onDeclined && t.onDeclined(D),
              t.ignoreDeclined ||
                (j = new Error(
                  "Aborted because of self decline: " + D.moduleId + H
                ));
            break;
          case "declined":
            t.onDeclined && t.onDeclined(D),
          ...
          case "unaccepted":
            t.onUnaccepted && t.onUnaccepted(D),
              t.ignoreUnaccepted ||
                (j = new Error(
                  "Aborted because " + s + " is not accepted" + H
                ));
            break;
          case "accepted":
            t.onAccepted && t.onAccepted(D), (E = !0);
            break;
          case "disposed":
            t.onDisposed && t.onDisposed(D), (M = !0);
            break;
          default:
        ...
        if (E)
          for (s in ((m[s] = y[s]),
          u(w, D.outdatedModules),
          D.outdatedDependencies))
            Object.prototype.hasOwnProperty.call(D.outdatedDependencies, s) &&
              (h[s] || (h[s] = []), u(h[s], D.outdatedDependencies[s]));
        M && (u(w, [D.moduleId]), (m[s] = b));
      }
    var I,
      x = [];
    for (r = 0; r < w.length; r++)
      (s = w[r]),
        P[s] &&
          ...
          m[s] !== b &&
          x.push({ module: s, errorHandler: P[s].hot._selfAccepted });
    f("dispose"),
    ...
    for (var A, S, T = w.slice(); T.length > 0; )
      if (((s = T.pop()), (a = P[s]))) {
        var U = {},
          q = a.hot._disposeHandlers;
        for (i = 0; i < q.length; i++) (n = q[i])(U);
        for (
          c[s] = U, a.hot.active = !1, delete P[s], delete h[s], i = 0;
          i < a.children.length;
          i++
        ) {
          var C = P[a.children[i]];
          C && (I = C.parents.indexOf(s)) >= 0 && C.parents.splice(I, 1);
        }
      }
    for (s in h)
      if (Object.prototype.hasOwnProperty.call(h, s) && (a = P[s]))
        for (S = h[s], i = 0; i < S.length; i++)
          (A = S[i]),
            (I = a.children.indexOf(A)) >= 0 && a.children.splice(I, 1);
    ...
    for (s in h)
      if (Object.prototype.hasOwnProperty.call(h, s) && (a = P[s])) {
        ...
        for (r = 0; r < S.length; r++)
          if (((A = S[r]), (n = a.hot._acceptedDependencies[A]))) {
  ...
  function (e, t, n) {
    ...
    n.r(t);
    n(1);
    var r = document.getElementsByTagName("main").item(0),
      o = Array.from(r.children),
      i = ["?", "?schedule", "?map", "?prizes", "?officehours"],
      c = new Map();
    ...
    var d = [
        "MakeMIT 2022 Day Of",
        "MakeMIT 2022 Schedule",
        "MakeMIT 2022 Map",
        "MakeMIT 2022 Prizes",
        "MakeMIT 2022 Office Hours",
      ],
      a = [0, 0, 0, 0];
    function s(e, t, n) {
      void 0 === t && (t = !0), void 0 === n && (n = !0);
      var c = +r.getAttribute("data-visible");
      if ((window.clearTimeout(a[e]), c != e)) {
        (a[c] = window.setTimeout(function () {
          return o[c].removeAttribute("style");
        }, 750)),
          o[c].removeAttribute("makemit-visible");
        var s = o[e];
        (s.style.display = "inherit"),
          window.getComputedStyle(s).opacity,
          window.getComputedStyle(s).transform,
          o[e].setAttribute("makemit-visible", ""),
          r.setAttribute("data-visible", "" + e),
          t &&
            (n ? window.history.pushState : window.history.replaceState).bind(
              window.history
            )(e, d[e], i[e]),
          (document.title = d[e]),
          console.log(c + ", " + e),
    ...
    for (var l = 0; l < o.length; l++)
      if (c.get(window.location.search) == l) {
        o[l].setAttribute("style", "display:inherit;"), s(l, !0, !1);
        break;
      }
    window.location.search ||
      ((o[0].style.display = "unset"),
      window.history.replaceState(0, d[0], i[0])),
      (c = void 0),
      (window.spa = s),
      (window.onpopstate = function (e) {
        (e.state || 0 == e.state) && s(e.state, !1);
      });
  },
  function (e, t, n) {},
]);
