...
const rmap = ["?", "?schedule", "?map", "?prizes", "?officehours", "?inperson", "?virtual"];
let map = new Map<string, number>();
rmap.forEach((s, i) => map.set(s, i));
const rmapT = ["MakeMIT 2023 Day Of", "MakeMIT 2023 Schedule", "MakeMIT 2023 Map", "MakeMIT 2023 Prizes", "MakeMIT 2023 Office Hours", "MakeMIT 2023 In-Person", "MakeMIT 2023 Virtual"];
